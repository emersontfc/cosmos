...
exports.getTime = (format, date) => {
	if (date) {
		...
		return moment.tz('Africa/Maputo').locale('id').format(format)
	}
}
...
exports.tanggal = (numer) => {
	myMonths = ["Janeiro","Fevereiro","March","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"];
				myDays = ['Domingo','Segunda-feira','terça-feira','Quarta-feira','Quinta-feira','Jum’at','Sabado']; 
				...
				const time = moment.tz('Africa/Maputo').format('DD/MM HH:mm:ss')
				let d = new Date
				let locale = 'id'
